    ...
    <body style="background: #eee">
        ...
        <section id="invoice">
            <div class="invoiceContent">
                        ...
                        <table class="slip_tbl1">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="td_data">{{session('payslip')->employee->region}}</td>
                                </tr>
                                <tr>
                ...
                @if (session('report_type') == 'billing')
                ...
                @elseif (session('report_type') == 'billing2')
                
                    @if (session('report_type') != 'employees')
                    ...
                    <div class="invCenter">
                        <table class="invCenterTbl">
                            <tbody>
                                ...
                                <tr>
                                    <td class="col-sm-5 cap1">{{session('report_type')}}' Report<br><br></td>
                                </tr>
                                @if (session('report_type') == 'payment')
                                    <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-3">{{'User'.date('hi').auth()->user()->id}}&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        ...
                                        @elseif (session('report_type') == 'taxation')
                                        ...
                                        @elseif (session('report_type') == 'salaries')
                                        ...
                                        @elseif (session('report_type') == 'employees')
                    ...
                    <div class="invBottom">
                        ...
                        @elseif (session('report_type') == 'Bank Summary')
