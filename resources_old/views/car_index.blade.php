...
@section('navlist')
  ...
  <li class="nav-item cta"><a href="https://apply.healthtraining.gov.gh/application" class="nav-link"><span>Buy Now</span></a></li>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="car_searchby col-md-4">
        ...
        <button type="button" class=""><i class="fa fa-search"></i>&nbsp; Search</button>
